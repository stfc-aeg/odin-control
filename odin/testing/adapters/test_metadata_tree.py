...
class TestMetadataTree():
    ...
    def test_basic_auto_metadata(self):
        metadata = {
            "int" : {"value" : self.basic_dict["int"], "type" : "int", "writeable" : True},
            "float" : {"value" : self.basic_dict["float"], "type" : "float", "writeable" : True},
    ...
    def test_nested_metadata(self):
        metadata = {
            "int" : {"value" : self.nested_dict["int"], "type" : "int", "writeable" : True},
            "float" : {"value" : self.nested_dict["float"], "type" : "float", "writeable" : True},
            "string" : {"value" : self.nested_dict["string"], "type" : "str", "writeable" : True},
            "bool" : {"value" : self.nested_dict["bool"], "type" : "bool", "writeable" : True},
            "dict" : {
                "0" : {"value" : self.nested_dict["dict"]["0"], "type" : "int", "writeable" : True},
                "1" : {"value" : self.nested_dict["dict"]["1"], "type" : "int", "writeable" : True}
            }
        }
    ...
    def test_accessor_value0_metadata(self):
        metadata = {"metadata_value0" : {"value" : 0, "type" : "int", "writeable" : False}}
